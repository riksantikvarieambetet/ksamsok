...
{	
	...
	public void performMethod() throws BadParameterException,
			DiagnosticException, MissingParameterException 
	{
		...
		} catch (IOException e)
		{
			throw new DiagnosticException("Oväntat IO fel. var god försök igen",
					"Facet.performMethod", e.getMessage(), true);
		}finally
		{
		...
		throws DiagnosticException
	{
		...
		{
			throw new DiagnosticException("Oväntat IO fel uppstod. Var god försök igen.",
					"Facet.doFacet", e.getMessage(), true);
		}
	}
